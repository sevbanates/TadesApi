...
public interface IEmailHelper
{
    ...
    ActionResponse<bool> SendTicketMessageMailToClient(TicketMessageMailModel model);
    ActionResponse<bool> SendTicketMessageMailToAdmin(TicketMessageMailModel model);
}